package org.bellona.dijkstra.structs.linkedlists
{
	...
	import org.bellona.dijkstra.structs.collections.ICollection;
	...
	public class LinkedList implements ICollection
	{
		...
		public function instertNode( index:uint, data:*, name:String = "" ):ListNode
		{
			var node:ListNode = new ListNode( data, name );
			var iterator:ListNode = _head;
			var counter:uint = 0;
